...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::connection('mostra_fotografia_2023')->create('avaliacao_iv', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::connection('mostra_fotografia_2023')->dropIfExists('avaliacao_iv');
    }
};
